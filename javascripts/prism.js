                                ...
                                for (var m = 0, y = 0; m < r.length; y += r[m].length, ++m) {
                                    ...
                                    if (!(v instanceof a)) {
                                        ...
                                        if (!b && h && m != r.length - 1) {
                                            ...
                                            for (var w = b.index + (c ? b[1].length : 0), _ = b.index + b[0].length, A = m, P = y, x = r.length; x > A && _ > P; ++A) P += r[A].length, w >= P && (++m, y = P);
                                        ...
                                        if (b) {
                                            ...
                                            j.push(N), S && j.push(S), Array.prototype.splice.apply(r, j)
                                        }
                                    }
                                }
                            }
...
}), Prism.languages.haxe.string.inside.interpolation.inside.rest = Prism.util.clone(Prism.languages.haxe), delete Prism.languages.haxe["class-name"];
...
}), Prism.languages.processing["function"].pattern = /[a-z0-9_]+(?=\s*\()/i, Prism.languages.processing["class-name"].alias = "variable";
...
! function() {
    "undefined" != typeof self && self.Prism && self.document && Prism.hooks.add("complete", function(e) {
        if (e.code) {
            ...
            if (t && /pre/i.test(t.nodeName) && !e.element.querySelector(".line-numbers-rows")) {
